...
copyright = u'2014, Leigh Simpson <code@simpleigh.com>'
...
latex_documents = [
  ('index', 'PythonWrapperfortheRingingClassLibrary.tex', u'Python Wrapper for the Ringing Class Library Documentation',
   u'Leigh Simpson \\textless{}code@simpleigh.com\\textgreater{}', 'manual'),
]
...
man_pages = [
    ('index', 'pythonwrapperfortheringingclasslibrary', u'Python Wrapper for the Ringing Class Library Documentation',
     [u'Leigh Simpson <code@simpleigh.com>'], 1)
]
...
texinfo_documents = [
  ('index', 'PythonWrapperfortheRingingClassLibrary', u'Python Wrapper for the Ringing Class Library Documentation',
   u'Leigh Simpson <code@simpleigh.com>', 'PythonWrapperfortheRingingClassLibrary', 'One line description of project.',
   'Miscellaneous'),
]
